use std::env;
use serde::Serialize;
use twitch_irc::{ ClientConfig, SecureTCPTransport, TwitchIRCClient, message::ServerMessage, login::StaticLoginCredentials };
...
async fn post_message(message: ChatMessage, url: &str, api_key: &str) -> Result<(), reqwest::Error> {
